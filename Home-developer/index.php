				        ...
				        <ul class="nav-menu">
						  ...
						  <li class="menu-has-children"><a href="">
							  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
								  ...
								  <li><a href="Payment/index.php">Payment</a>
								  </li>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-10">
							<div class="title text-center">
								...
								<a href="menu/menu.php" class="btn btn-dark pull-right pull-right" style="background:#B68734; border-style: none; position:
								absolute; top:0; right:0; margin-top: 80px;"><i class="fa fa-plus"></i> Edit Menu</a></h3>
							</div>
						</div>
					</div>						
					<div class="row">
