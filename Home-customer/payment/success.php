            ...
            <br><br><br><br>
                <div class="container">
                    <div class="card">
                        ...
                        <br>
                        <h1>Hooray! <br>You have successfully paid for the order!</h1>
                        <p>Thank you for your purchase.</p>
                        <br>
                        <p>Have a great day!</p>
                        <br><br>
                        <a href="../index.php"><input type="submit" class="btn btn-dark" style="background:#433533; border-style: none; width: 400px;" value="Home"></a>
